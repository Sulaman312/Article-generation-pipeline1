...
export const STEP_BOUNDARY_LABEL =
  /^(?:TOPIC CARD|SERP RESEARCH|SERP ANALYSIS|SOURCE RESEARCH|ATP TOPIC RESEARCH|PAA FAQ RESEARCH|CASE STUDY RESEARCH|RESEARCH AUDIT|SUPPORTING POSTS|RESEARCH|BRIEF|OUTLINE|DRAFT|FACT CHECK|META SEO|FINAL OUTPUT|FINAL ARTICLE)\s+(?:START|END)$/i;
